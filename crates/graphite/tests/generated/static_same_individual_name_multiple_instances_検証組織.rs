...
// 生成元: tests/static_same_individual_name_multiple_instances.rs:32
...
pub(super) const __GRAPHITE_STATIC_SCHEMA_FINGERPRINT: [u64; 4] = [
    18249134051422985587u64, 7756645160003696486u64, 128034068372024925u64,
    2880517977371862017u64,
];
