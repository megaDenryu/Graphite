...
// 生成元: crates/graphite/tests/named_graph.rs:28
...
pub(super) const __GRAPHITE_SCHEMA_FINGERPRINT: [u64; 4] = [
    13201141666245813876u64, 12483263827101309227u64, 18083326593280257250u64,
    18230775871575125806u64,
];
...
impl Purchase {
    ...
    /// この役割に接続する辺を O(1) で参照し、挿入順に走査する。
    /// 問い合わせ時に結果 `Vec` を確保しない。
    pub fn of_item<'g>(node: ItemRef<'g>) -> impl Iterator<Item = PurchaseRef<'g>> + 'g {
