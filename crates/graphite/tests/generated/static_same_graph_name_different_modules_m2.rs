...
// 生成元: tests/static_same_graph_name_different_modules.rs:61
...
pub(super) const __GRAPHITE_STATIC_INSTANCE_FINGERPRINT: [u64; 4] = [
    9952348999199040773u64, 3025146921674632038u64, 9012691984656073711u64,
    732428337408226795u64,
];
...
macro_rules! construct {
    () => {
        { let (甲,) = __graphite_values_衝突検査グラフ_85d814ed2cd1b3e4!(); let
        () = __graphite_payloads_衝突検査グラフ_85d814ed2cd1b3e4!();
