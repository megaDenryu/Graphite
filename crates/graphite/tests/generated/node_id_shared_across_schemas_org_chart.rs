...
pub(super) const __GRAPHITE_SCHEMA_FINGERPRINT: [u64; 4] = [
    13045214413401744650u64, 15775869607434311927u64, 15355188892597122140u64,
    3304021999049018096u64,
];
...
impl BelongsTo {
    ...
    pub fn of_person<'g>(node: PersonRef<'g>) -> Option<BelongsToRef<'g>> {
        node.graph
            .belongs_to_from_index
