...
// 生成元: tests/each_declaration_order.rs:39
...
pub(super) const __GRAPHITE_SCHEMA_FINGERPRINT: [u64; 4] = [
    16143299896236277265u64, 9758574617277993398u64, 3009405246076753883u64,
    2514621876790534015u64,
];
/// `Author` ノードの公開ID。
///
