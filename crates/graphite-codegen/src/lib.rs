...
//! ファイルは150行を超える。このファイルの本体は99行であり、超過分は同居す
//! る単体テストである。テストの移設を含めた判定は issue #28 のやること4 が
//! 行う。超過を許す根拠の台帳は `docs/development/line_count_ledger.md` に
//! ある。
